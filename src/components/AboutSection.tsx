      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-on-scroll opacity-0">
            ...
            <div className="flex items-center gap-8 bg-forex-lightgray p-6 rounded-xl">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-forex-green mb-1">40+</div>
                <div className="text-sm text-forex-gray">Countries</div>
              </div>
              <div className="h-12 w-px bg-gray-300"></div>
              <div className="text-center">
                <div className="text-3xl font-bold text-forex-green mb-1">5k+</div>
                <div className="text-sm text-forex-gray">Clients</div>
              </div>
            </div>
          </div>
